...
export function createNotification(text:string, type:string) {
  ...
  const notificationClasses = "text-gray-50 p-3 flex-auto"
  ...
  let notificationShellClasses = "mx-5 my-2 min-w-[400px] w-fit rounded-xl border border-secondary-50 text-sm shadow-lg bg-neutral-900 border border-solid flex z-10 justify-center"
